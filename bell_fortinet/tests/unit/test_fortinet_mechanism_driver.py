...
from bell_fortinet.tests.unit import (
...
class TestFortinetMechDriver(mocked.FortinetTestCase):
    ...
    def setUp(self):
        ...
        self.patcher1 = mock.patch(
            'bell_fortinet.db.models.Fortinet_ML2_Namespace')
        self.patcher2 = mock.patch(
            'bell_fortinet.common.resources.Vdom')
        self.patcher3 = mock.patch(
            'bell_fortinet.db.models.Fortinet_Interface')
    ...
    @mock.patch('bell_fortinet.common.resources.VlanInterface')
...
#        self.assertTrue(self.namespace_db.add_record.called)
    ...
    def test_delete_network_precommit(self, VlanInterface):
        ...
        with mock.patch('bell_fortinet.db.models.query_record',
                        side_effect=[None, namespace, 'fgt_intf']):
            self.driver.delete_network_precommit(mech_context)

    @mock.patch('bell_fortinet.common.resources.VlanInterface')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vdom_Vlink')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vlink_Vlan_Allocation')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vlink_IP_Allocation')
    @mock.patch('bell_fortinet.db.models.Fortinet_Static_Router')
    @mock.patch('bell_fortinet.common.resources.RouterStatic')
    @mock.patch('bell_fortinet.common.resources.VdomLink')
    def test_delete_network_postcommit(self, VlanInterface,
        ...
        with mock.patch('bell_fortinet.db.models.query_count',
                        return_value=0):
            with mock.patch('bell_fortinet.db.models.query_record',
                            return_value=namespace):
                    with mock.patch(
                             'bell_fortinet.db.models.query_records',
                             return_value='cool'):
                        self.driver.delete_network_postcommit(mech_context)

    @mock.patch('bell_fortinet.db.models.Fortinet_Static_Router')
    @mock.patch('bell_fortinet.common.resources.RouterStatic')
    @mock.patch('bell_fortinet.db.models.Fortinet_ML2_Subnet')
    @mock.patch('bell_fortinet.common.resources.DhcpServer')
    @mock.patch('bell_fortinet.common.resources.VlanInterface')
    ...
    @mock.patch('bell_fortinet.db.models.Fortinet_Firewall_Address')
    @mock.patch('bell_fortinet.common.resources.FirewallAddress')
    @mock.patch('bell_fortinet.common.resources.FirewallAddrgrp')
    @mock.patch('bell_fortinet.db.models.Fortinet_Firewall_Policy')
    @mock.patch('bell_fortinet.common.resources.FirewallPolicy')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vlink_Vlan_Allocation')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vlink_IP_Allocation')
    @mock.patch('bell_fortinet.db.models.Fortinet_Vdom_Vlink')
    @mock.patch('bell_fortinet.common.resources.VdomLink')
    ...
    @mock.patch('bell_fortinet.db.models.Fortinet_Static_Router')
    @mock.patch('bell_fortinet.common.resources.RouterStatic')
    @mock.patch('bell_fortinet.db.models.Fortinet_Firewall_IPPool')
    @mock.patch('bell_fortinet.common.resources.FirewallIppool')
    @mock.patch('bell_fortinet.db.models.Fortinet_ML2_ReservedIP')
    @mock.patch('bell_fortinet.common.resources.DhcpServerRsvAddr')
    @mock.patch('bell_fortinet.db.models.Fortinet_Interface_subip')
    def test_create_port_precommit_and_del_port_postcommit(self,
        ...
        with mock.patch('bell_fortinet.db.models.query_record',
            ...
            with mock.patch('bell_fortinet.db.models.query_records',
                        side_effect=[[fwaddr]]):
        ...
        with mock.patch('bell_fortinet.db.models.query_record',
            ...
            with mock.patch('bell_fortinet.common.utils.getip',
    ...
    def test_create_port_postcommit(self):
        mech_context = self._setup_port_context()
        with mock.patch('bell_fortinet.tasks.tasks.TaskManager'):
